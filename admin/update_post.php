            ...
            <div class="col-md-offset-3 col-md-6">
                <?php 
                    if(isset($_GET['id'])){
                        ...
                        $post_id = $_GET['id'];
                            ...
                            $query = "SELECT posts.post_id, posts.title, posts.description, posts.post_img, posts.category, categories.category_name FROM posts 
                ...
                <form action="save_update_post.php" method="POST" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <img src="upload/<?php echo $row['post_img']; ?>" height="150px" width="100px">
